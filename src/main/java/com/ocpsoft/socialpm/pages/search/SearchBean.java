...
{
   private static final long serialVersionUID = -503011911192515862L;
   ...
   {
      search();
      return facesUtils.beautify(UrlConstants.SEARCH);
   }
   ...
   public void setSearchResults(final List<String> searchResults)
   {
   }
}
